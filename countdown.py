...
class CountDown:
    ...
    def create_widgets(self):
        self.title_label = tk.LabelFrame(self.root, text='Compte à rebours', font=('cambria', 14, 'bold'), bg="white",
                                         fg="black" ,  )
        self.title_label.place(x=3 * self.screen_width / 10 + 120, y=7.3 * self.screen_height / 9)
        # ----------------------------------------
        ...
        tk.Button(self.title_label, text="20 Secondes", command=lambda: self.submit(30),
    ...
    def submit(self, temps):
        ...
        while self.temps > -1:
            ...
            self.decompte_label.configure(text=self.temps)
