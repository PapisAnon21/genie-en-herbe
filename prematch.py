...
class Prematch:
    ...
    def create_widgets(self):
        ...
        # Valider les donnees
        valider = tk.Button(self.root, text='Valider les entrées', command=lambda: self.lancer_le_match(None),
                            font=('calibri', '15', 'bold'), bg='#c59c1b', fg='black')
    ...
    def lancer_le_match(self, event):
        ...
        if self.players.verifier_champs_joueurs():
            ...
            self.message_alerte['text'] = 'Entrez toutes les donnees valides du match'
